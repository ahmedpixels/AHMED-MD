...
module.exports = async (sock, m) => {
    ...
    // Check Authorization (Private Mode & Sudo)
    ...
    const isAuthorized = isOwner || isSudo || config.PRIVATE_MODE !== 'true';

    if (!isAuthorized) {
        return; // Do nothing if not authorized and in private mode
    }
