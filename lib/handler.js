            ...
            try {
                ...
                if (deletedKey?.id) {
                    ...
                    if (enabled && original) {
                        ...
                        let txt = original.message?.conversation || original.message?.extendedTextMessage?.text || original.message?.imageMessage?.caption || original.message?.videoMessage?.caption || '[Media]'
